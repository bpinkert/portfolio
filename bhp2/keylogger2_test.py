...
def main():
	...
	parser.add_option('--stdout', help='True to print in terminal, false to just log to file. Defaults false', dest = 'pterm', default = False, action = 'store')
