...
def main():
	global logfile
	global termvar
	parser = optparse.OptionParser('usage = %prog --file <filename in %TEMP% folder> --term <True/False> -h for help')
	...
	# parser.add_option('--term', help='True to print in terminal, false to just log to file. Defaults false', dest = 'pterm', default = 'False', action = 'store_true')
	...
	# elif term == False: 
	# 	print "[-] Not printing to terminal! \n"
	# 	exit(0)
